                        ...
                        children: [
                          Expanded(
                            child: CustomButton(
                              ...
                              onPressed: () async {
                                final users = await Provider.of<UserDbHelper>(
                                        context,
                                        listen: false)
                                    .getUsers();
                                if (users.isEmpty) {
                                  ...
                                  final loans = await Provider.of<LoanDbHelper>(
                                          context,
                                          listen: false)
                                      .getLoans();
                                  final readings =
                                  ...
                                  if (loans.any((loan) =>
                                    ...
                                    showDialog(
                                      ...
                                      builder: (BuildContext context) {
                                        return AlertDialog(
                                          title:
                                              const Text('Livro já emprestado'),
                                          content: const Text(
                                    ...
                                    customDialogBox(
                                        ...
                                        SizedBox(
                                          ...
                                          child: FutureBuilder<List<User>>(
                                            future: Provider.of<UserDbHelper>(
                                                    context,
                                                    listen: false)
                                                .getUsers(),
                                            builder: (BuildContext context,
                          ...
                          Expanded(
                            child: CustomButton(
                              ...
                              onPressed: () async {
                                ...
                                final readings =
                                    await Provider.of<ReadingDbHelper>(context,
                                            listen: false)
                                        .getReadings();
                                if (loans.any((loan) =>
                                    loan.book.id == book.id &&
